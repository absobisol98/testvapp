...
class CreateEvent extends CreateRecord
{
    ...
    protected function handleRecordCreation(array $data): Model
    {
        ...
        if($data['recurrence_type_id'] == 2){ // Recurring
            ...
            $repeat_until = Carbon::parse($data['repeat_until'])->endOfDay();
            ...
            if($recurrence){
                ...
                if($start->format('Y-m-d H:i:s') > Carbon::now()->setTimezone('Asia/Manila')->format('Y-m-d H:i:s')){
                    ...
                    if ($data['media']) {
                        foreach ($data['media'] as $media) {
                            $event->addMedia(storage_path('app/public/'.$media))->toMediaCollection(
                                'event-attachments'
                            );
                        }
                    }
                ...
                while ($start->format('Y-m-d H:i:s') < $repeat_until->format('Y-m-d H:i:s'))
                {
