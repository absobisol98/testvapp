            ...
            @foreach ($opportunities as $opportunity)
                <div class="col-span-1 flex flex-col justify-between shadow-md h-full">
                    ...
                    <div class="w-full text-[14px] p-4">
                        ...
                        <p class="text-2xl font-[700] text-[#0433ff] mt-3 mb-1 leading-none capitalize">
                        ...
                        <div class="h-fit max-h-[80vh] overflow-y-auto mb-4">
                            <div class="flex flex-col  items-center justify-center">
                                ...
                                <div class="w-full p-4 flex flex-col gap-4">
                                    ...
                                    <p class="text-4xl font-normal text-[#0433ff]">{{ $opportunity->title }}</p>
                                    ...
                                    <div class="w-full flex items-center justify-center gap-4">
                                        <div class="w-full">
                                            ...
                                            <div
                                                ...
                                                <a href="">
                                                    <div
                                                        class="h-[53px] w-[229px] bg-[#0433ff] flex items-center justify-center p-2 hover:bg-[#1A67B1]">
