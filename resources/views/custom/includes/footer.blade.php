    ...
    <div class="w-full grid grid-cols-1 md:grid-cols-4 gap-8 mb-4 md:mb-8">
        ...
        <div class="w-full flex flex-col items-start justify-center gap-[24px] text-[16px] font-semibold">
            ...
            <div class="flex items-center justify-between w-full">
                <img class="w-[200px] md:w-[280px]" src="{{ asset('img/logo-colored.png') }}" alt="Ayala Logo">
            ...
            <div class="flex items-center justify-between w-full md:w-fit gap-6 mt-4">
                <!-- Facebook -->
                <a href="https://facebook.com/ayalafoundation/" class="bg-[#e87722] p-3 rounded-full hover:bg-[#004b87] transition-all duration-300 flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z"/>
                    </svg>
                </a>
                <!-- Twitter -->
                <a href="https://x.com/ayalafoundation" class="bg-[#e87722] p-3 rounded-full hover:bg-[#004b87] transition-all duration-300 flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"/>
                    </svg>
                </a>
                <!-- Instagram -->
                <a href="https://www.instagram.com/ayalafoundation/" class="bg-[#e87722] p-3 rounded-full hover:bg-[#004b87] transition-all duration-300 flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <!-- YouTube -->
                <a href="https://www.youtube.com/AyalaFoundationInc" class="bg-[#e87722] p-3 rounded-full hover:bg-[#004b87] transition-all duration-300 flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M19.615 3.184c-3.604-.246-11.631-.245-15.23 0-3.897.266-4.356 2.62-4.385 8.816.029 6.185.484 8.549 4.385 8.816 3.6.245 11.626.246 15.23 0 3.897-.266 4.356-2.62 4.385-8.816-.029-6.185-.484-8.549-4.385-8.816zm-10.615 12.816v-8l8 3.993-8 4.007z"/>
                    </svg>
                </a>
                <!-- LinkedIn -->
                <a href="https://ph.linkedin.com/company/ayala-foundation" class="bg-[#e87722] p-3 rounded-full hover:bg-[#004b87] transition-all duration-300 flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
