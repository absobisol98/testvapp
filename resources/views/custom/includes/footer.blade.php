    ...
    <div class="w-full flex flex-col md:flex-row items-center justify-start gap-[100px]">
        ...
        <div class="w-full max-w-[400px] grid grid-cols-2 gap-[10px]">
            {{-- <div class="col-span-1 flex flex-col items-start justify-center gap-1 text-[20px] font-[400]">
                <div class="w-full">
                    ...
                    <div class="w-full">
                        <a class="hover:underline" href="">Menu Link 2</a>
                    </div>

                    <div class="w-full">
                        <a class="hover:underline" href="">Menu Link 3</a>
                    </div>

                    <div class="w-full">
                        <a class="hover:underline" href="">Menu Link 4</a>
                    </div>

                    <div class="w-full">
                        <a class="hover:underline" href="">Menu Link 5</a>
                    </div>

                    <div class="w-full">
                        <a class="hover:underline" href="">Menu Link 6</a>
                    </div>
        ...
        <div class="w-full flex">
            <div class="col-span-1 w-full flex flex-col items-end justify-end">
                <img style="max-width:15%; height:auto;" src="{{ asset('img/npc-logo.png') }}" alt="">
            </div>
        </div>
    </div>
</div>
