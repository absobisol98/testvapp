<div id="footer" class="py-[5%] px-[5%] bg-[#F2F2F2] relative">
    <div class="w-full grid grid-cols-1 md:grid-cols-4 gap-8 mb-4 md:mb-8">

            <div class="w-[280px] flex flex-col items-start justify-center gap-[24px] text-[16px] font-semibold">
                ...
                <div class="flex flex-col gap-3">
                    <nav class="flex flex-col gap-3 text-[#004b87]">
            ...
            <div class="flex w-full gap-12">
                <div class="w-[280px] flex flex-col items-start justify-center gap-[24px] text-[14px] font-semibold">
                    <h3 class="text-[#004b87] font-bold text-xl">Contact Us</h3>
                    <div class="flex flex-col gap-6">
                        <div class="flex items-center text-[#004b87] gap-3">
                            <svg class="w-20 h-20 text-[#004b87]" fill="#e87722" stroke="white" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-center text-[#004b87] gap-3">
                            <svg class="w-8 h-8 text-[#004b87]" fill="#e87722" stroke="none" viewBox="0 0 24 24">
            ...
            <div class="w-full flex">
                <div class="w-full flex flex-col items-end justify-end">
                    {{-- <img class="w-[120px] h-auto object-contain" src="{{ asset('img/npc-logo.png') }}" alt="NPC Logo"> --}}
                </div>
            </div>
            <div class="w-full flex flex-col items-end justify-end">
                <img class="w-auto h-[250px] object-contain" src="{{ asset('img/npc-logo.png') }}" alt="NPC Logo">
            </div>
    </div>
    <div class="w-full absolute bottom-12 left-0 px-[5%]">
        <p class="text-[18px] font-semibold text-[#004b87]">© 2025 Ayala Foundation, Inc. All Rights Reserved</p>
    </div>
</div>
