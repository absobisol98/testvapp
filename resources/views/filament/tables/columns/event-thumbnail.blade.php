...
<!-- FIX: hover shadow class added -->
<div class="bg-white rounded-2xl overflow-hidden flex flex-col
     hover:shadow-[0_8px_28px_rgba(0,20,50,.14)] transition-shadow duration-200"
    ...
    <div class="relative h-44 overflow-hidden bg-gray-200 flex-shrink-0">
        ...
        @if($timeBadge)
            <div class="absolute top-2.5 left-2.5">
                <span class="inline-flex items-center bg-white/90 backdrop-blur-sm
                      text-gray-800 text-[11px] font-semibold px-2.5 py-1 rounded-full
                      shadow-sm leading-none">{{ $timeBadge }}</span>
            </div>
        @endif

        <div class="absolute bottom-2.5 left-2.5">
            <span class="inline-flex items-center gap-1 bg-black/50 backdrop-blur-sm
                  text-white text-[11px] font-medium px-2.5 py-1 rounded-full leading-none">
    ...
    <div class="flex flex-col flex-1 px-4 pt-4 pb-3 gap-2">
        ...
        <div class="flex flex-col gap-1.5 mt-0.5">
            ...
            <!-- FIX: min-w-0 on parent + child for proper truncation -->
    ...
    <div class="px-4 pb-4 flex items-center gap-2">
        ...
        @if($canEdit || $canDelete || $canSetFeatured)
            <div x-data="{ open: false }" style="position:relative; flex-shrink:0;">
                ...
                <!-- dropdown: Edit / Make Featured / Delete / Export -->
