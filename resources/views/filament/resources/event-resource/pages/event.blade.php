    ...
    <div class="w-full bg-white rounded-xl shadow">
        <div class="px-4 py-4 space-y-4">
            ...
            <div class="flex flex-col justify-center items-center">
                ...
                <p class="text-md md:text-lg lg:text-base font-normal text-[#F55E1D] capitalize">{{$record->program_id}}</p>
            </div>
            <div class="flex flex-col justify-center items-center">
                <p class="text-md md:text-lg lg:text-base font-normal capitalize">&emsp; &emsp;{{$record->description}}</p>
            </div>
        </div>
    </div>
        ...
        <div class="px-4 py-4 space-y-4">
            ...
            <div class="w-full flex flex-col md:flex-row space-y-4" style="width:100%">
                <div class="w-full md:w-3/5 flex flex-col space-y-2" style="width:100%">
                    ...
                    <p class="text-black md:pl-20 lg:pl-0 text-md inline-flex items-center">
                        <svg class="w-8 h-4 mr-4" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"> <path d="M12 2a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm1 10.59l3.29 3.3a1 1 0 0 1-1.42 1.42l-3.3-3.29a1 1 0 0 1-.29-.7V7a1 1 0 0 1 2 0v5.59z"></path></svg><strong>Shift: &nbsp;</strong>
                    </p>
                    <br>
                    <p class="text-black md:pl-20 lg:pl-0 text-md inline-flex items-center font-bold">Volunteer Responsibility</p>
                    <p class="text-md md:text-lg lg:text-base pr-4 font-normal capitalize">&emsp; &emsp;Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages</p>
                </div>
                ...
                <div class="w-full flex flex-col space-y-2" style="width:40%">
                    ...
                    <div class="w-full flex flex-col">
                        <p class="text-md md:text-lg lg:text-base text-start font-bold">Point-of-Contact: {{$record->point_of_contact_id}}</p>
