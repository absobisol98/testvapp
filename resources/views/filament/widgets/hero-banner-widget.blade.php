                ...
                <div class="w-full grid grid-cols-2 gap-4 mx-auto sm:grid-cols-3 lg:grid-cols-5">
                    ...
                    @if (false)
                        <div class="col-span-1 flex flex-col items-center justify-center gap-2 bg-[#FFFFFFCC] p-8">
                            <p class="text-[40px] font-[700] text-[#F55E1D]"></p>
                    ...
                    @if (true)
                        <div class="col-span-1 flex flex-col items-center justify-center gap-2 bg-[#FFFFFFCC] p-8">
                            <p class="text-[40px] font-[700] text-[#F55E1D]">{{ \App\Models\User::count() }}</p>
                            <p class="text-[14px] font-[700] text-[#03498D]">VOLUNTEERS</p>
                        </div>

                        <div class="col-span-1 flex flex-col items-center justify-center gap-2 bg-[#FFFFFFCC] p-8">
                            <p class="text-[40px] font-[700] text-[#F55E1D]">{{ \App\Models\Event::count() }}</p>
                            <p class="text-[14px] font-[700] text-[#03498D]">OPPORTUNITIES</p>
                        </div>

                        <div class="col-span-1 flex flex-col items-center justify-center gap-2 bg-[#FFFFFFCC] p-8">
                            <p class="text-[40px] font-[700] text-[#F55E1D]">{{ \App\Models\Program::count() }}</p>
                            <p class="text-[14px] font-[700] text-[#03498D]">PROGRAMS</p>
                        </div>

                        <div class="col-span-1 flex flex-col items-center justify-center gap-2 bg-[#FFFFFFCC] p-8">
                            <p class="text-[40px] font-[700] text-[#F55E1D]">{{ \App\Models\Company::count() }}</p>
                            <p class="text-[14px] font-[700] text-[#03498D]">BUSINESS UNIT</p>
                        </div>

                        <div class="col-span-1 flex flex-col items-center justify-center gap-2 bg-[#FFFFFFCC] p-8">
                            <p class="text-[40px] font-[700] text-[#F55E1D]">{{ \App\Models\EventFacilitator::count() }}</p>
